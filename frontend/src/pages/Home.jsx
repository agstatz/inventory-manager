...
import HeaderImageReference from "../assets/headerimage.jpg";
    ...
    return (
        <>
            ...
            <Box width="100%" bg="brand.300" color="brand.600">
                <Center>
                    <Box bg="brand.500" m={[10, 10, 30, 40]} mt={[20, 20, 20, 20]} borderRadius="5px" maxWidth="1020px">
                        <Image width="100%" src={HeaderImageReference} borderTopRadius="5px" my="-10"></Image>    
